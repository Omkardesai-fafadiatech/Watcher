...
def title_spliter(full_title):
    if full_title.title.find("]") != -1:
        ...
        pre_label, pre_title_context = title_label_cleaner(full_text[0]), title_context_cleaner(f"{full_text[1:]}")
        if pre_title_context.find("]") != -1:
            full_text1 = re.split('\]', pre_title_context)
            label1, title_context1 = title_label_cleaner(full_text1[0]), title_context_cleaner(f"{full_text1[1:]}")
        ...
        label, title_context = title_label_cleaner(full_text[0]), title_context_cleaner(f"{full_text[1:]}")
